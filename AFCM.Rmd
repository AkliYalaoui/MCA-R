...
On a 125 individus, ici nous allons considérer que les modalités avec un effectif moins de 15 est trés faible, donc on va éliminer ces modalités, nous avons opter pour cette option pour alléger un peu le nombre de colonne [ on avait 120 modalités] 
